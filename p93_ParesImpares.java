/**
 * p93_ParesImpares - Declare dos arreglos de números enteros de una cantidad MAX 100 (a[MAX], b[MAX]), tambien rellene el arreglo a[]
 * con números aleatorios entre 0 y 20 muestre elementos del arreglo, muestre solo los elementos que son pares y los cuente, muestre 
 * solo los elementos que son impares y los cuente, muestre la cuenta de pares y muestre la cuenta de impares.
 */
