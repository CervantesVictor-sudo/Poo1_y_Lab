...
public class App extends JFrame implements ActionListener {
    ...
    public App() {
        ...
        lblDatos = new JLabel("<html>Examen Tercer Parcial<br>Programación Oriendada a Objetos I<br>Victor Manuel Cervantes Carrillo</html>",JLabel.CENTER);
        lblDatos.setFont(new Font("Times New Roman",Font.BOLD, 17));
