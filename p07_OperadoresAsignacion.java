// p07_OperadoresAsignación - Efectua operaciones usando los diferentes operadores de asignación.
...
public class p07_OperadoresAsignacion {
    public static void main(String[] args) {
        ...
        System.out.printf("Incrementar 1 digito : %.2f\n", ++num);
        ...
        System.out.printf("Decrementar 1 digito : %.2f\n", --num);
    }
}
